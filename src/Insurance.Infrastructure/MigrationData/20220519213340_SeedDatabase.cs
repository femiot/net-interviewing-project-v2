...
namespace Insurance.Infrastructure.MigrationData
{
    public partial class SeedDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("Insert INTO InsuranceExtraCosts (ProductName, ExtraCost, ApplyCostRangeRule, DateCreated, CreatedByUserId) VALUES ('Laptops', 500, 0, '2022-05-19', 'System')");
            migrationBuilder.Sql("Insert INTO InsuranceExtraCosts (ProductName, ExtraCost, ApplyCostRangeRule, DateCreated, CreatedByUserId) VALUES ('Smartphones', 500, 0, '2022-05-19', 'System')");
            migrationBuilder.Sql("Insert INTO InsuranceExtraCosts (ProductName, ExtraCost, ApplyCostRangeRule, DateCreated, CreatedByUserId) VALUES ('Digital cameras', 500, 0, '2022-05-19', 'System')");
